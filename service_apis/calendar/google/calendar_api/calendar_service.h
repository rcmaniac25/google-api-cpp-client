 ...
 *      <tr><th>Generated At<td>2014-04-29 16:13:17 UTC
...
class AclResource_ListMethod : public CalendarServiceBaseRequest {
 public:
  ...
  virtual ~AclResource_ListMethod();
     ...
     *
     * @param[in] value Token obtained from the 'nextSyncToken' field returned
     * as part of the result of a previous call to this method. It makes the
     * result of this call contain only entries that have changed since the last
     * call, including entries that have been removed in the meantime (they will
     * have the 'role' set to 'none'). Optional. The default is to return to all
     * entries.
     */
     ...
     * acls are represented by with 'role' equal to 'none'. Deleted acls will
     * always be included if 'syncToken' is provided. Optional. The default is
     * False.
     */
...
class CalendarListResource_ListMethod : public CalendarServiceBaseRequest {
 public:
  ...
  virtual ~CalendarListResource_ListMethod();
     ...
     *
     * @param[in] value Token obtained from the 'nextSyncToken' field returned
     * on the last result page of the previous method's call. It makes the
     * result of this call contain only entries that have changed since the last
     * call. Optional. The default is to return all entries.
     */
    void set_sync_token(const string& value) {
      _have_sync_token_ = true;
      sync_token_ = value;
